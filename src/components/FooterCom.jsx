    ...
    <footer className="bg-gradient-to-r from-blue-800 via-blue-600 to-blue-800 py-12 text-white">
      <div className="container mx-auto px-6 lg:px-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
          {/* Contact Section */}
          <div>
            <h2 className="text-2xl font-semibold mb-4 text-gray-100">Contact</h2>
          ...
          {/* Location Section */}
          <div>
            <h2 className="text-2xl font-semibold mb-4 text-gray-100">Location</h2>
          ...
          {/* Follow Section */}
          <div>
            <h2 className="text-2xl font-semibold mb-4 text-gray-100">Follow</h2>
          ...
          {/* Policies Section */}
          <div>
            <h2 className="text-2xl font-semibold mb-4 text-gray-100">Quick Links</h2>
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="#"
